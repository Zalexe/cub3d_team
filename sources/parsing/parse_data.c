...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/09/10 17:31:54 by cmarrued          #+#    #+#             */
/*   Updated: 2025/09/10 17:31:55 by cmarrued         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "cub3d.h"

// count lines in file map
...
//parse map into struct and count its lines
void	parse_data(char *path, t_data *data)
{
	...
	data->mapinfo.file = ft_calloc(
			data->mapinfo.line_count + 1, sizeof(char *));
