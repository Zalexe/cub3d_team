...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/09/10 17:31:48 by cmarrued          #+#    #+#             */
/*   Updated: 2025/10/16 19:12:35 by intherna         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "cub3d.h"

//get the path of the texture from line
...
//save path to textures in texture struct
...
//ignore spaces and nonprint. if not digit, parse direction textures and colors
//if digit, parse map file
...
//after parsing data into struct, we parse each line of the file
